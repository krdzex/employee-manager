...
import OnlyUser from './Auth/OnlyUser';
import Only from './Auth/OnlyUser';
    ...
    return (
        <div>
            ...
            <Routes>
                ...
                <Route path="/viewTeam/:id" element={<OnlyUser />}>
                    <Route path="" element={<SingleTeam />} />
                </Route>
                <Route exact path="/editTeam/:id" element={<EditTeam />} />

                <Route exact path="/projects" element={<Only />}>
