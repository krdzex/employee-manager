    ...
    return (
        <div className="employeesWrapper">
            <div className="header">
                ...
                {authHelper.isAuthentcated().user.role === "Admin" && (<Link to="/employeeAdd"><div className="iconAdd">
                ...
                <table>
                    <thead>
                        <tr>
                            ...
                            <td>Email</td>
                            <td>Phone</td>
                            {authHelper.isAuthentcated().user.role === "Admin" && (<td>Actions</td>)}
                        </tr>
                    </thead>
                    <tbody>
                        {allEmployees.map((employee, id) => (
                            <tr key={id}>
                                ...
                                {authHelper.isAuthentcated().user.role === "Admin" && (<td>
