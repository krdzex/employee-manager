                            ...
                            <tr key={id}>
                                ...
                                <td>
                                    <div style={{ display: "flex", alignItems: "center", justifyContent: "center" }} >
                                        ...
                                        {console.log()(authHelper.isAuthorizedProjects(project._id) || authHelper.isAuthentcated().user.role === "Admin") && (<Link to={`/viewProject/${project._id}`} ><p style={{ marginRight: "10px" }}>View</p></Link>)}
                                    </div>
                                </td>
                            </tr>))}
                    </tbody>
