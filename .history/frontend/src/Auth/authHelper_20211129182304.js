...
const isAuthorizedProjects = async (id) => {
    ...
    let projectInformation = await projectInfo(id);
    let teamInformation = await teamInfo(projectInformation.team);
...
export default { authenticate, isAuthentcated, signOut, isAuthorized, isAuthorizedProjects }