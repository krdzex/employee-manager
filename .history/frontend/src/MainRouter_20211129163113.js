...
import OnlyAdminRouteUser from './Auth/OnlyAdminRouteUser';
import OnlyAdminRoute from './Auth/OnlyAdminRouteUser';
    ...
    return (
        <div>
            ...
            <Routes>
                ...
                <Route path="/viewTeam/:id" element={<OnlyAdminRouteUser />}>
                    <Route path="" element={<SingleTeam />} />
                </Route>
                <Route exact path="/editTeam/:id" element={<EditTeam />} />

                <Route exact path="/projects" element={<OnlyAdminRoute />}>
