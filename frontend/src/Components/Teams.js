    ...
    return (
        <div className="teamsWrapper">
            <div className="header">
                ...
                <Link to="/addTeam"><div className="iconAdd">
                    <Icon icon="carbon:add-filled" />
                </div></Link>
            </div>
            <div className="allTeams">
                <Swiper slidesPerView={3} centeredSlides={true} spaceBetween={30} pagination={{
                    "type": "fraction"
            ...
            <div className="teamMembers">
                <div className="header">
                    ...
                    {allTeams.length > 0 && (<div className="iconAdd" onClick={() => dispatch(openTeamMemberPopUp())}>
                        <Icon icon="carbon:add-filled" />
                    </div>)}
                </div>
                {currentTeamInfo.emyploees !== undefined && currentTeamInfo.emyploees.length > 0 ? <Swiper slidesPerView={5} spaceBetween={30} pagination={{
                    "type": "fraction"
